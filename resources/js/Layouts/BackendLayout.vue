...
const navigation = [
    { name: 'Dashboard', href: '/admin/dashboard', icon: HomeIcon, current: route().current('dashboard') },
    { name: 'Products', href: '/admin/products', icon: FolderIcon, current: route().current('products.index') },
